  ...
  return (
    <div>
      <div className='container my-5'>
        ...
        <button className='btn btn-info mb-3' onClick={() => { setAction('add'); setNewEmployee(''); openModal(); }}>Add an Employee</button>
                            ...
                            <tbody>
                              {employees.map(employee => (
                                <tr key={employee.userId}>
                                  ...
                                  <td><button type='button' className='btn btn-outline-info' onClick={() => { setAction('update'); updateEmployee(employee.userId) }}>Update Employee</button></td>
                                  <td><button type='button' className='btn btn-outline-info mx-3' onClick={() => { deleteEmployee(employee.userId) }}>Delete Employee</button></td>
                                </tr>
                              ))}
                            </tbody>
                          </table>
          ...
          <div className='modal-content'>
            ...
            <form>
              ...
              <div className='modal-footer'>
                ...
                {action === 'add' ? <button type='submit' className='btn btn-info' onClick={addEmployee}>Add Employee</button> : <button type='submit' className='btn btn-info' onClick={() => { confirmEmployeeUpdate(newEmployee.userId) }}>Confirm Employee Update</button>}
              </div>
            </form>
          </div>
        </div>
