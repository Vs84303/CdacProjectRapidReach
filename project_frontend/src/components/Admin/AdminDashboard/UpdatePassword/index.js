  ...
  return (
    <div className='container my-5'>
      ...
      <form>
        ...
        <button type='button' className='btn btn-outline-info' onClick={() => props.setCurrentComponent({name: 'Profile'})}>Cancel</button>
        <button type='submit' className='btn btn-info mx-3' onClick={updatePassword}>Update Password</button>
      </form>
    </div>
  )
}
