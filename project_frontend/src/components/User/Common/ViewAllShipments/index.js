...
import ViewAllShipments1 from './images/ViewAllShipments1.jpg'
        ...
        <div className='container my-5'>
            <div className='row'>
                <div className='col'>
                    ...
                    {loggedIn ? (
                        <Link className='btn btn-info my-3' to={'/client/dashboard'}>Log in to the Dashboard</Link>
                    ) : (
                        <Link className='btn btn-info my-3' to={'/login'}>Log in to the dashboard</Link>
                    )}
                    <p>
                        New here ?
                        {loggedIn ? (
            ...
            <div className='container my-5 py-5'>
                ...
                <div className='d-flex justify-content-center my-3'>
                    {loggedIn ? (
                        <Link className='btn btn-info' to={'/client/dashboard'}>Log in to Join</Link>
                    ) : (
                        <Link className='btn btn-info' to={'/login'}>Log in to Join</Link>
                    )}
                </div>
            </div>
            <div className='my-5 py-5'>
                <div className='row'>
                    <div className='col'>
                        ...
                        <p className='lead'>Supercharge your shipping. Get total visibility and control with a RapidReach account.</p>
                        {loggedIn ? (
                            <Link className='btn btn-info my-3' to={'/client/dashboard'}>Sign Up</Link>
                        ) : (
                            <Link className='btn btn-info my-3' to={'/signup'}>Sign Up</Link>
                        )}
                        <p>
                            Already enrolled ?
                            {loggedIn ? (
