        ...
        <>
            <div className='container my-5' >
                ...
                <form className='row g-3'>
                    ...
                    <div className='col-12'>
                        <button type='submit' className='btn btn-info my-3' onClick={checkout}>Checkout</button>
                    </div>
                </form>
            </div>
            ...
            <div className='modal fade' id='staticBackdrop' data-bs-backdrop='static' data-bs-keyboard='false' tabIndex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true' ref={modalRef2}>
                <div className='modal-dialog modal-xl'>
                    <div className='modal-content'>
                        ...
                        <div className='modal-footer'>
                            <button type='button' className='btn btn-info' onClick={navigateToNextPage}>Close</button>
                        </div>
                    </div>
                </div>
            </div >
